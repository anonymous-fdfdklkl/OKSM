...
if __name__=="__main__":
    ...
    parser.add_argument('--name', default="FG_HK", type=str, help='Optional name for saving and tensorboard')
    ...
    parser.add_argument('--cs_num', default=3, type=int, help='gpu number')
