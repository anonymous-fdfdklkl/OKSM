...
N = 'fiw-HK_trip_tanhNet_7type_loss5_hard'
epoch = {'fiw-HK_trip_CNN_point_Net_7type':60,'fiw-HK_trip_CNN_Net_7type':60,'fiw-JLNet_7type':50,
         'fiw-close_7type':100,'fiw-class_7type':100,'fiw-cac_7type':100,
         'fiw-HK_trip_tanhNet_7type_loss5':60,'fiw-HK_trip_tanhNet_7type_loss5_hard':40,
         'fiw-HK_trip_tanhNet_notanh':0,'fiw-HK_trip_tanhNet_different_7type':0,
         'fiw-FG_adam':10,'fiw-HK_trip_FG_adam':0,
         'fiw-HK_trip_tanhNet_7type_loss3':0, 'fiw-HK_trip_tanhNet_7type_loss4':0,
         }[N]
...
for trial_num in range(args.start_trial, args.start_trial + args.num_trials):
    ...
    kin_related_label = [True if i in [7, 8, 9, 10] else False for i in y]
    unknon_nonkin_label = [True if i in [-1] else False for i in y]
    name_dict = {'fiw-HK_trip_CNN_point_Net_7type': 'cnn_point',
                    'fiw-HK_trip_CNN_Net_7type': 'attention',
                'fiw-JLNet_7type': 'jlnet',
                'fiw-close_7type': 'atten+softmax',
                'fiw-class_7type': 'atten_softmax*',
                    'fiw-cac_7type': 'cac',
                # 'fiw-HK_trip_tanhNet_7type': 'hkmnet',
                    'fiw-HK_trip_tanhNet_7type_loss5': 'hkmnet',
                    # 'fiw-HK_trip_tanhNet_c_loss5':'c_loss5',
                    'fiw-HK_trip_tanhNet_7type_loss5_hard': 'hkmnet_hard',
                'ARPL': 'arpl',
                ...
                'fiw-HK_trip_tanhNet_7type_loss3':'loss3', 'fiw-HK_trip_tanhNet_7type_loss4': 'loss4',
